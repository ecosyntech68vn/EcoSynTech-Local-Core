...
import mlMetrics from('../../metrics/mlMetrics');
import WebLocalBridge from('../../services/weblocal/WebLocalBridge');
import path from('path');
import fs from('fs');
import logger from('../../config/logger');
import { getBreaker } from('../circuitBreaker');

import DEFAULT_MODEL_PATH = path.join(__dirname, '../../../models/lightgbm_yield.onnx');
...
import lgbmBreaker = getBreaker('lightgbm-predictor', breakerConfig);
