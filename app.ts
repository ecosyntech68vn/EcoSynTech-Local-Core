...
import formatter = new Intl.NumberFormat("vi-VN");

import qs = (selector, scope = document) => scope.querySelector(selector);
import qsa = (selector, scope = document) => Array.from(scope.querySelectorAll(selector));
