'use strict';
const GasHybridClient = require('./services/gasHybridClient');
const DeviceSecretsSync = require('./services/deviceSecretsSync');
...
function wireRoutes(app, deps) {
  ...
  const deviceActionRouter = require('./routes/deviceAction');
