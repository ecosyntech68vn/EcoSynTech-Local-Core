...
export function getSchemaFromPath(pathName: string): Joi.Schema | null {
...
export function validate(schema: Joi.Schema, data: any): ValidationResult {
...
export function validateMiddleware(schemaName: string) {
