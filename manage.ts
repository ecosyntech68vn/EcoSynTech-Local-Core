...
import { createOps, skills } from('./src/ops');
import { SkillScheduler } from('./src/ops/scheduler');
...
switch (command) {
  ...
  case 'backup':
    ...
    var AutoBackup from('./src/ops/advanced').AutoBackup;
