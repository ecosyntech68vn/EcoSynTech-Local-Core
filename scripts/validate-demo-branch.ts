...
import readme = path.join(root, 'README.md');
if (exists(readme)) {
...
import sopPath = path.join(root, 'docs', 'security', 'DEMO_SHARING_SOP.md');
if (!exists(sopPath)) {
